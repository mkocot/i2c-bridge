...
#define W_BASE_CLOCK (FUNCONF_USE_HSI * HSI_VALUE * (FUNCONF_USE_PLL ? FUNCONF_USE_PLL * FUNCONF_PLL_MULTIPLIER : 1))
#define W_TICK_RATIO (W_BASE_CLOCK / FUNCONF_SYSTEM_CORE_CLOCK)
